const Privacy = () => (
  <section className="PrivacyPolicy-page">
    <div>
      ...
      <p>All personal information are saved by Paypal.</p>
      <br />
      <br />
      <p className="question hot-pink italic">SECTION 7- COOKIES</p>
      <p>
        We use cookies in order to remember the product in your cart after
        refresh of a page.
      </p>
      <br />
      <br />
      ...
      <p>
        ...
        information, contact us at hello@justadashbeauty.com.au
      </p>
    </div>
  </section>
);
